...
# Understand, Match, Plan, Implement, Review, Evaluate
    # Understand the Problem
        #   Understand what the interviewer is asking with
        #       clarifying questions
        #   Generate basic sample input and output
        #   Explore more unusual edge cases
        #   Explore tradeoffs (memory, performance, code 
    ...
    # Implement the Solution
        ...
        #       - A clear plan should be relativelu easy to 
        #           translate. If it's hard to translate, 
